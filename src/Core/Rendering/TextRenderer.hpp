...
namespace Forradia
{
    ...
    class TextRenderer
    {
      ...
      private:
        ...
        const std::string k_defaultFontPath{
            "./resources/fonts/PixeloidSans.ttf"}; ///< Relative font files path.
        std::unordered_map<FontSizes, std::shared_ptr<TTF_Font>>
            m_fonts; ///< Initialized font sizes.
    };
}
